(() => {
  ...
  const sceneInfo = [
    ...
    },
    {
      ...
      values: {
        ...
        messageC_translateY_in: [30, 0, { start: 0.79, end: 0.81 }],
        messageA_opacity_in: [0, 1, { start: 0.15, end: 0.2 }],
        messageB_opacity_in: [0, 1, { start: 0.5, end: 0.55 }],
        messageC_opacity_in: [0, 1, { start: 0.77, end: 0.8 }],
  ...
  function setCanvasImages() {
    ...
    let imgElem3;
    for (let i = 0; i < sceneInfo[3].values.imagesPath.length; i++) {
      imgElem3 = new Image();
  ...
  function setLayout() {
    ...
    for (let elem of sceneInfo) {
      if (elem.type === "sticky") {
        ...
        elem.scrollHeight = elem.objs.container.offsetHeight;
      }
    }
  ...
  function calcValues(values, currentYOffset) {
    ...
    if (values.length === 3) {
      ...
      if (currentYOffset >= partScrollStart && currentYOffset <= partScrollEnd) {
        ...
        calcedValue = values[0];
      } else if (currentYOffset > partScrollEnd) {
        calcedValue = values[1];
      }
    } else {
      calcedValue = scrollRatio * (values[1] - values[0]) + values[0];
    }
  ...
  function playAnimation() {
    ...
    switch (currentScene) {
      ...
      case 3:
        ...
        sceneInfo[3].objs.canvas.style.transform = `scale(${canvasScaleRatio})`;
        sceneInfo[3].objs.context.drawImage(objs.images[0], 0, 0);
